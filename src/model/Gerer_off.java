		 ...
		 public void ajouter(offreur e) 
		    {
			 Connection connexion=connect.loadDatabase();
		        ...
		        try {
		            PreparedStatement preparedStatement = connexion.prepareStatement("INSERT INTO offreur_service(nom, prenom,email,password,phone,nom_service,descreption,ville,genre) VALUES(?,?,?,?,?,?,?,?,?);");
		            ...
		            preparedStatement.setInt(5,e.getPhone());
		 ...
		 public void updateOffreurr (int id ,offreur e)
			{
				Connection connexion=connect.loadDatabase();
				 try {
			            PreparedStatement preparedStatement = connexion.prepareStatement("update offreur_service set nom='"+e.getNom()+"',prenom='"+e.getPrenom()+"',email='"+e.getEmail()+"',password='"+e.getPassword()+"',phone='"+e.getPhone()+"',nom_service='"+e.getService()+"',descreption='"+e.getDescreption()+"',ville='"+e.getVille()+"',genre='"+e.getGenre()+"' where ID_off='"+id+"'");
 ...
 public static void updatePicture(String fname,int id)
		 {
			 Connection connexion=connect.loadDatabase();
			 try {
		            PreparedStatement preparedStatement = connexion.prepareStatement("update offreur_service set photo='"+fname+"' where ID_off='"+id+"'");
