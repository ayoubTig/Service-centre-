...
<span>Resultat (<% out.println(); %> Annonces)</span>
</div>
...
<div class="row">
				...
				<% 
							String idr = (String) request.getParameter("idd");
							
	 						ArrayList<Annonce> an = Categorie.getAnnonceOfCategorie(Integer.parseInt(idr));
	 						
			 				for(int i=0;i<an.size();i++)
						 {
			 					int idOff = Annonce.getIdOff(an.get(i).getId());
			 					String nom = Annonce.selectNom(idOff);
			 					int idCat = an.get(i).getId_cat();
		...
		<a href="detail_annonce.jsp?idd=<%= an.get(i).getId() %>"><img class="img-fluid" src="img/<%= an.get(i).getImage() %>" alt=""></a>
		</figure>
		<div class="feature-content">
		<div class="product">
		<a href="detail_annonce.jsp?idd=<%= an.get(i).getId() %>"><% out.println(an.get(i).getType()); %></a>
		</div>
		<h4><a href="detail_annonce.jsp?idd=<%= an.get(i).getId() %>"><% out.println(an.get(i).getTitle()); %></a></h4>
		
		<ul class="address">
		<li>
		<a href="detail_annonce.jsp?idd=<%= an.get(i).getId() %>"><i class="lni-map-marker"></i> Agadir</a>
		</li>
		<li>
		<a href="detail_annonce.jsp?idd=<%= an.get(i).getId() %>"><i class="lni-alarm-clock"></i> <% out.println(an.get(i).getDatepub()); %></a>
		</li>
		<li>
		<a href="Ann.jsp?id_off=<%=an.get(i).getId_off()%>"><i class="lni-user"></i> <% out.println(nom); %></a>
		</li>
		
		</ul>
		<div class="listing-bottom">
		<h3 class="price float-left"><% out.println(an.get(i).getPrice()); %> DH</h3>
		</div>
		</div>
		</div>
		</div>
...
<div class="row">
				...
				<% 
						...
						<%String url=annonce_func.getImage(an.get(i).getImage()); %>
						<a href="detail_annonce.jsp?idd=<%= an.get(i).getId() %>"><img class="img-fluid" src="img/<%=an.get(i).getImage() %>" alt=""></a>
						</figure>
						<div class="feature-content">
						<div class="product">
						...
						<div class="listing-bottom">
						<h3 class="price float-left"><% out.println(an.get(i).getPrice()); %> DH</h3>
						<a href="detail_annonce.jsp?idd=<%= an.get(i).getId() %>" class="btn-verified float-right"><i class="lni-check-box"></i> Details</a>
						</div>
						</div>
						</div>
						</div>
