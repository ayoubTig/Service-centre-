...
<title>Inscreption Offreur de service</title>
...
<form class="login-form" role="form" action="gerer"  method="post">
...
</div><span class="erreur">${erreurs['phone']}</span>
</div>
<div class="form-group">
<div class="input-icon">
<i class="lni-lock"></i>
<input type="password" name="password" class="form-control" placeholder="password" required>
</div><span class="erreur">${erreurs['password']}</span>
</div>
<div class="form-group">
<div class="input-icon">
<i class="lni-lock"></i>
...
<div class="form-group">
	 <select name="nom_service"  class="form-control" required>
	 <% 
	 //String[] cats = new String[25];
	 ArrayList<String> cats = new ArrayList<String>();
	 cats= Categorie.getAllCategorie();
	 for( String  arr: cats )
	 {%>
		 <option value='<% out.println(arr); %>'> <% out.println(arr); %> </option>
	 <%}
...
<textarea  input type="text" name="descreption" rows="5" cols="40"  placeholder="votre description*" required></textarea>
</div>
