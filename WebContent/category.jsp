...
Déposez une annonce gratuite. (<%out.print(idPage);%> - 10 annonces of <%out.print(annonce_func.compterNombreAnnonceAccepter()); %> annonces)</span>
</div>
<div class="Show-item">
...
particuliers. Vous êtes à la recherche d'une personne  apte à remplir une mission ponctuelle ou à plus long  terme dans n'importe quel domaine ? SERVLUX	vous 
propose une liste des annonces des services qui peuvent  compléter votre mission	.Que vous soyez à la recherche  d'un photographe afin d'immortaliser votre mariage, d'une 
 personne apte à faire vos courses ou pour vous aider à déménager ,SERVLUX.com vous aide à trouver pour tous les services dont vous avez besoin.</p>
</div>
</div>
</div>
