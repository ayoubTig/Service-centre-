...
<%  try {if((char)session.getAttribute("erreur_d'authentification")=='1') { %>
<h2 class="product-title" Style="color: #FF8C00;"    >Erreur d'authentification assure vos informations </h2> 
<%}} catch(Exception e){ } %>
<ol class="breadcrumb">
...
<form role="form" class="login-form"  action="loginoff" method="get">
...
<a href="offr.jsp">S'inscrire si vous n'avez pas de compte</a>
</div>
</form>
</div>
</div>
